<!-- background picture for entire div containing navbar and hero section -->
<div class="section1 bg-[#000000] opacity-100">
...
">Activities</a
  ...
  <!-- div with header, a motto and a "contact us" button -->
  <div>
    <h2
      class="w-[54px] h-[18px] mt-20 ml-40 opacity-60 font-serif font-bold text-sm tracking-[0.4px] text-white"
    >
      MOTTO
    </h2>
    <p
